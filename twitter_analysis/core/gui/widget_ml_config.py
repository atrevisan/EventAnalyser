...
class WidgetMLConfig(QWidget, Ui_widget_ml_config):
    ...
    def generate_ngram_per_hour(self, file_name, ngram):
        """Generate the ngrams and ngrams per cluster hourly distribution graphs.
        ...
        ngram : string
            The ngram from wich the hourly frequency distribution graphs
            will be generated
        """

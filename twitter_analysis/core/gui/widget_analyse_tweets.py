...
class WidgetAnalyseTweets(QWidget, Ui_widget_analyse_tweets):
    ...
    def add_ngrams_widget(self):
        ...
        self.clear_layout()
        widget_ngrams = WidgetNGrams(self.tweets, self.dataset_top_ngrams, self.analyser, self.file_name)
    ...
    def add_ngrams_per_cluster_widget(self):
        ...
        self.clear_layout()
        widget_ngrams_per_cluster = WidgetNGramsPerCluster(self.tweets, self.top_ngrams_per_cluster, self.file_name)

        self.vlayout_content.addWidget(widget_ngrams_per_cluster)
    ...
    def open_tweets_file(self):
        ...
        with open(file_name[:-4] + '_vectorizer.pkl', 'rb') as input:

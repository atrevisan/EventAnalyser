...
#
# Created: Thu May 21 10:08:41 2015
...
" } "))
        ...
        self.widget = QtGui.QWidget(widget_ngrams)
...
" } "))
        ...
        self.widget_2 = QtGui.QWidget(widget_ngrams)
...
" } "))
    ...
    def retranslateUi(self, widget_ngrams):
        ...
        self.radio_frequency.setText(_translate("widget_ngrams", "Frequency", None))
        self.radio_retweets.setText(_translate("widget_ngrams", "Retweets", None))
        self.radio_positive_sentiment.setText(_translate("widget_ngrams", "Positive Sentiment", None))
        self.radio_negative_sentiment.setText(_translate("widget_ngrams", "Negative Sentiment", None))
        self.label.setText(_translate("widget_ngrams", "Year:", None))
        self.button_info_per_month.setText(_translate("widget_ngrams", "Info per month", None))
        self.label_3.setText(_translate("widget_ngrams", "Month:", None))
        self.button_info_per_day.setText(_translate("widget_ngrams", "Info per day", None))
        self.label_4.setText(_translate("widget_ngrams", "Day:", None))
        self.button_info_per_hour.setText(_translate("widget_ngrams", "Info per hour", None))

...
# Form implementation generated from reading ui file 'widget_hashtags_per_cluster.ui'
#
# Created: Wed Apr  1 08:52:05 2015
...
class Ui_widget_hashtags_per_cluster(object):
    def setupUi(self, widget_hashtags_per_cluster):
        widget_hashtags_per_cluster.setObjectName(_fromUtf8("widget_hashtags_per_cluster"))
        widget_hashtags_per_cluster.resize(779, 549)
        self.label_graph = QtGui.QLabel(widget_hashtags_per_cluster)
...
" } "))
        ...
        self.layoutWidget = QtGui.QWidget(widget_hashtags_per_cluster)
        self.layoutWidget.setGeometry(QtCore.QRect(390, 10, 241, 31))
        ...
        self.widget = QtGui.QWidget(widget_hashtags_per_cluster)
...
" } "))
        ...
        self.widget_2 = QtGui.QWidget(widget_hashtags_per_cluster)
...
" } "))
        ...
        self.layoutWidget_2 = QtGui.QWidget(widget_hashtags_per_cluster)
        ...
        self.retranslateUi(widget_hashtags_per_cluster)
        QtCore.QMetaObject.connectSlotsByName(widget_hashtags_per_cluster)

    def retranslateUi(self, widget_hashtags_per_cluster):
        widget_hashtags_per_cluster.setWindowTitle(_translate("widget_hashtags_per_cluster", "Form", None))
        self.label_2.setText(_translate("widget_hashtags_per_cluster", "Hashtags:", None))
        self.radio_frequency.setText(_translate("widget_hashtags_per_cluster", "Frequency", None))
        self.radio_retweets.setText(_translate("widget_hashtags_per_cluster", "Retweets", None))
        self.radio_positive_sentiment.setText(_translate("widget_hashtags_per_cluster", "Positive Sentiment", None))
        self.radio_negative_sentiment.setText(_translate("widget_hashtags_per_cluster", "Negative Sentiment", None))
        self.label.setText(_translate("widget_hashtags_per_cluster", "Year:", None))
        self.button_info_per_month.setText(_translate("widget_hashtags_per_cluster", "Info per month", None))
        self.label_3.setText(_translate("widget_hashtags_per_cluster", "Month:", None))
        self.button_info_per_day.setText(_translate("widget_hashtags_per_cluster", "Info per day", None))
        self.label_4.setText(_translate("widget_hashtags_per_cluster", "Day:", None))
        self.button_info_per_hour.setText(_translate("widget_hashtags_per_cluster", "Info per hour", None))
        self.label_5.setText(_translate("widget_hashtags_per_cluster", "Clusters:", None))
